...
class Starter:
    def __init__(self, name):
        self.photo = "https://telegra.ph/file/554cd669af5323ad6fc8d.jpg"
        ...
        query.message.edit_caption(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="Github 🔭", url="https://github.com/theshashankk"
                        ),
                        InlineKeyboardButton(
                            text="By Me A Coffe 🖤", url="https://www.buymeacoffee.com/TheShashank"
                        ),
                    ],
                    [
                        InlineKeyboardButton(
